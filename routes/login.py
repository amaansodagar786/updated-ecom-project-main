...
def login_google():
    ...
    """
    redirect_uri = url_for('login.google_auth_callback', _external=True)
...
def google_auth_callback():
    ...
    try:
        ...
        redirect_url = f"http://mtm-store.com/auth-callback?token={token}&user={json.dumps(response_data['user'])}"
